...
public class vanidad_spiral_phase extends BaseShipSystemScript {
...
//			}
		...
		stats.getMaxSpeed().modifyFlat(id+"_spiral", 50f*effectLevel);
                stats.getTurnAcceleration().modifyFlat(id+"_spiral", 50f*effectLevel);
                stats.getAcceleration().modifyFlat(id+"_spiral", 70f*effectLevel);
                stats.getDeceleration().modifyFlat(id+"_spiral", 30f*effectLevel);
                stats.getMaxTurnRate().modifyFlat(id+"_spiral", 20f*effectLevel);
...
//		stats.getEmpDamageTakenMult().unmodify(id);
		...
		stats.getMaxSpeed().unmodify(id+"_spiral");
		stats.getMaxTurnRate().unmodify(id+"_spiral");
		stats.getTurnAcceleration().unmodify(id+"_spiral");
		stats.getAcceleration().unmodify(id+"_spiral");
		stats.getDeceleration().unmodify(id+"_spiral");
//		stats.getMaxSpeed().unmodify(id);
