 ...
 */
public class vanidad_beamFlakEffectMedium extends vanidad_beamFlakEffect {
    private final Color PARTICLE_COLOR = new Color(215, 225, 255, 255);
    private final float EXPLOSION_DAMAGE = 120f;
    private final float EXPLOSION_RANGE = 250f;
    private final float MIN_RANGE_FOR_FULL_EXPLOSION  = 700;
    private final float MIN_RANGE_FOR_NO_EXPLOSION = 150;
