...
public class vanidad_ionizadorThrustPlugin implements EveryFrameWeaponEffectPlugin {
    ...
    private final float FREQ=0.05f, SMOOTH_THRUSTING=0.35f;        
    ...
    private Vector2f size= new Vector2f(18,114);
